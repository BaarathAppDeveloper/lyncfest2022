        ...
        <div className=" w-full   space-y-4  ">
          <div className="w-[100%] flex flex-row items-center justify-evenly  sm:flex-col ">
            <div className=" flex flex-col items-center justify-center   space-y-3 ">
              ...
              <div className="max-w-md  sm:flex sm:space-x-6  dark:text-gray-100">
                <div className="">
                  <div className="flex flex-col justify-center space-y-3 p-5 dark:bg-gray-900 mr-6">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-lg font-nunito">
                        <a href="mailto:lyncfest@sairamit.edu.in">
                    ...
                    <div className="space-y-1 font-nunito">
                      ...
                      <span className="flex items-center space-x-2">
                        ...
                        <span className="dark:text-gray-400">984079984</span>
                      </span>
                    </div>
                    <br />
                    <div className="space-y-1 font-nunito">
          ...
          <div className=" flex flex-col items-center justify-center w-[100%]">
            <center className="py-4">
              <text className="text-xl font-semibold font-nunito text-white py-10">
                Lyncfest
              </text>
              <br />
            ...
            <center className="py-7">
              <text className="text-xl font-semibold font-nunito text-white">
                IT Dept, SIT
              </text>
              <div className="flex flex-wrap  pl-3 space-x-4 ">
                <div>
