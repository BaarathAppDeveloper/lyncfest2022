            ...
            <div class="bg-black">
                <section class="text-gray-600 body-font">
                    <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
                        <img class=" object-cover object-center rounded" alt="hero" src={linkimg} height={300} width={300} />
                        <div class="text-center px-20 w-full">
                            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-bold text-gray-900">Link-a-Link</h1>
                            <p class="mb-8 leading-relaxed text-white font-medium text-lg text-left flex-col items-center">
                                ...
                                1) Team size should be 3 members<br />

                                2) This game consists of Two Rounds<br />
                                <br/>

                                *Formal Round (Finding movie names, dialogues,songs,...etc)<br />

                                    * Technical Round (Final Round)<br /><br />

                                3) Participants should come with their College I'd Card<br />

                                4) Seletion Process for first round will be based on total entries of team<br />
