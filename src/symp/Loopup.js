        ...
        <section class="text-gray-600 body-font">
          <div class="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
            ...
            <div class="text-center lg:w-2/3 w-full">
              <h1 class="title-font sm:text-4xl text-4xl mb-4 font-medium text-white">
                Loop up
              </h1>
              <p class="mb-8 leading-relaxed py-5 text-left flex-col items-center text-white text-lg font-semibold">
                ...
                <center class="text-2xl py-5 text-left flex-col items-center text-white text-lg font-semibold">
                  This is an Individual participant event.
                </center>
                <p>
                  ...
                  <br />
                  <br />
                  You will be given problems in C, C++ and JAVA. The logic
                  should not be changed.
                  <br />
                  This round will be evaluated based on your debugging skills
                  and time taken.
                  <br />
                  You will be evaluated and shortlisted for the second round.
                  <br />
                  Timing: 11:00 am to 11:45 am
                  <br />
                  <br />
                  Round 2- Coding round
                  <br />
                  <br />
                  You will be given a problem statement. You are free to use any
                  of the following languages. C, C++, JAVA and Python.
                  <br />
                  This round will be evaluated based on your approach in solving
                  the problem and the time taken to solve it.
                  <br />
                </p>
              </p>
              <div class="flex justify-center">
                <a href="https://forms.gle/E7YCbJiyakyj8bb79">
